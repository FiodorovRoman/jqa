...
public class QuestionServiceImplTest {
  ...
  private void getSortedAndPagedQuestionList_returnsMappedPage() {
    ...
    repository.pageResult = new Page<>(List.of(question), PageRequest.of(0, 5, Sort.by(Sort.Direction.DESC, "createdAt")));
    ...
    assertEquals(question.getCreatedBy().getUsername(), itemView.getAuthor(), "List item author");
